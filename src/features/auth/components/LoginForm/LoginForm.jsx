...
function LoginForm() {
    ...
    // 6. Hàm xử lý khi form hợp lệ (Không còn lỗi)
    const onSubmit = (data) => {
        // data sẽ là object: { email: '...', password: '...' }
            ...
            <div className={cx('modal-content')}>
                ...
                <form className={cx('login-form')} onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className={cx('form-group')}>
                        ...
                        />
                        <FontAwesomeIcon className={cx('eye-icon')} icon={showPassword ? faEye : faEyeSlash} onClick={togglePasswordVisibility}/>
